...
class AboutUsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, HomeViewModel>(
      ...
      builder: (_, viewModel) => _AboutUsScreenContent(
        viewModel: viewModel,
      ),
    );
  }
...
class _AboutUsScreenContent extends StatefulWidget {
  final HomeViewModel viewModel;

  const _AboutUsScreenContent({super.key, required this.viewModel});

  @override
  State<_AboutUsScreenContent> createState() => _TermsAndConditionsScreenState();
}

class _TermsAndConditionsScreenState extends State<_AboutUsScreenContent> {
  @override
  void initState() {
    super.initState();
      this.widget.viewModel.getPageData("about-us");
  }
