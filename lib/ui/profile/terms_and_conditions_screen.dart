...
class TermsAndConditionsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, HomeViewModel>(
      ...
      builder: (_, viewModel) => _TermsAndConditionsScreenContent(
        viewModel: viewModel,
      ),
    );
  }
...
class _TermsAndConditionsScreenContent extends StatefulWidget {
  final HomeViewModel viewModel;

  const _TermsAndConditionsScreenContent({super.key, required this.viewModel});

  @override
  State<_TermsAndConditionsScreenContent> createState() => _TermsAndConditionsScreenState();
}

class _TermsAndConditionsScreenState extends State<_TermsAndConditionsScreenContent> {
  @override
  void initState() {
    super.initState();
    this.widget.viewModel.getPageData("terms-conditions");
  }
